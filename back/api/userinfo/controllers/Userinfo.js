...
/**
 * A set of functions called "actions" for `Userinfo`
 */

module.exports = {

  /**
   * Get Userinfo entries.
   *
   * @return {Object|Array}
   */
  ...
  /**
   * Add an entry to a specific Userinfo.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Userinfo.
   *
   * @return {Object}
   */
